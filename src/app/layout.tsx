      ...
      <body className="bg-white dark:bg-black">
        <div className="flex min-h-screen">
          ...
          <div className="flex-1 flex flex-col">
            {/* 상단 내비게이션 */}
            <header className="sticky top-0 bg-white dark:bg-black border-b thread-border z-10 backdrop-filter backdrop-blur-sm bg-opacity-80 dark:bg-opacity-80">
              <div className="flex justify-between items-center p-4">
                <div className="flex items-center">
                  <h2 className="text-lg font-semibold">대시보드</h2>
                </div>
                <div className="flex items-center space-x-2">
                  <button className="relative p-2 rounded-full thread-hover">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5"
                      fill="none"
                  ...
                  <button className="p-2 rounded-full thread-hover">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5"
                      fill="none"
            ...
            {/* 메인 콘텐츠 */}
            <main className="flex-1 overflow-y-auto transition-all duration-300 ease-in-out p-4">
              {children}
            </main>
          </div>
        </div>
